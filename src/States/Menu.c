    ...
    if (IsKeyPressed(KEY_ENTER))
    {
        switch (s_menuSelection)
        {
            ...
            case 3:
                ...
                break;
            default:
                g_gameData->isExitWindowRequested = true;
        }
    }
}
...
void DrawSnake(const GameData* game)
{
    ...
    for (unsigned short pos = 40; pos < SCREEN_WIDTH - 8; pos += 16)
        DrawTexturePro(*s_texture, (Rectangle){16, 0, 16, 16}, (Rectangle){pos, 8, 16, 16}, (Vector2){8, 8}, 90, WHITE);
    for (unsigned short pos = 24; pos < SCREEN_WIDTH - 8; pos += 16)
        DrawTexturePro(*s_texture, (Rectangle){16, 0, 16, 16}, (Rectangle){pos, SCREEN_HEIGHT - 8, 16, 16}, (Vector2){8, 8}, 90, WHITE);
    for (unsigned short pos = 24; pos < SCREEN_HEIGHT - 8; pos += 16)
        DrawTexturePro(*s_texture, (Rectangle){16, 0, 16, 16}, (Rectangle){8, pos, 16, 16}, (Vector2){8, 8}, 0, WHITE);
    for (unsigned short pos = 24; pos < SCREEN_HEIGHT - 8; pos += 16)
        DrawTexturePro(*s_texture, (Rectangle){16, 0, 16, 16}, (Rectangle){SCREEN_WIDTH - 8, pos, 16, 16}, (Vector2){8, 8}, 0, WHITE);

    DrawTexturePro(*s_texture, (Rectangle){0, 0, 16, 16}, (Rectangle){8, 8, 16, 16}, (Vector2){8, 8}, 0, WHITE);
    DrawTexturePro(*s_texture, (Rectangle){0, 16, -16, 16}, (Rectangle){8, SCREEN_HEIGHT - 8, 16, 16}, (Vector2){8, 8}, 0, WHITE);
    DrawTexturePro(*s_texture, (Rectangle){0, 16, 16, 16}, (Rectangle){SCREEN_WIDTH - 8, SCREEN_HEIGHT - 8, 16, 16}, (Vector2){8, 8}, 0, WHITE);
    DrawTexturePro(*s_texture, (Rectangle){0, 16, 16, -16}, (Rectangle){SCREEN_WIDTH - 8, 8, 16, 16}, (Vector2){8, 8}, 0, WHITE);
    DrawTexturePro(*s_texture, (Rectangle){16, 16, 16, 16}, (Rectangle){24, 8, 16, 16}, (Vector2){8, 8}, 90, WHITE);
}